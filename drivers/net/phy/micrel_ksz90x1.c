...
static void ksz9021_config_rgmii_delay(struct phy_device *phydev)
{
	...
	drv->writeext(phydev, 0, 0, MII_KSZ9021_EXT_RGMII_CLOCK_SKEW, clk_dly);
	drv->writeext(phydev, 0, 0, MII_KSZ9021_EXT_RGMII_RX_DATA_SKEW, rx_dly);
	drv->writeext(phydev, 0, 0, MII_KSZ9021_EXT_RGMII_TX_DATA_SKEW, tx_dly);
}
